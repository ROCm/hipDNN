    ...
    namespace graph
    {
        ...
        public:
            ...
            Batchnorm_inference_attributes&
                set_mean(const std::shared_ptr<Tensor_attributes>& value)
            {
            ...
            Batchnorm_inference_attributes&
                set_scale(const std::shared_ptr<Tensor_attributes>& value)
            {
                return set_input(input_names::scale, value);
            }
            Batchnorm_inference_attributes&
                set_bias(const std::shared_ptr<Tensor_attributes>& value)
            {
        ...
        private:
            ...
            Batchnorm_inference_attributes&
                set_input(input_names name, const std::shared_ptr<Tensor_attributes>& value)
            {
                inputs[name] = value;
                return *this;
            }
            ...
            Batchnorm_inference_attributes&
                set_output(output_names name, const std::shared_ptr<Tensor_attributes>& value)
            {
                outputs[name] = value;
                return *this;
            }
