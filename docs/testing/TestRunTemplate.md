...
71 - CpuFpReferenceImplementation.BasicFloatUsage (Skipped)
72 - CpuFpReferenceImplementation.BasicBFloat16Usage (Skipped)
73 - CpuFpReferenceImplementation.BasicHalfUsage (Skipped)
74 - CpuFpReferenceImplementaion.BasicDoubleUsage (Skipped)
75 - CpuFpReferenceValidation.BasicBFloat16Usage (Skipped)
76 - CpuFpReferenceValidation.BasicHalfUsage (Skipped)
77 - CpuFpReferenceValidation.BasicFloatUsage (Skipped)
78 - CpuFpReferenceValidation.BasicDoubleUsage (Skipped)
79 - CpuFpReferenceValidation.BFloat16NotComparable (Skipped)
80 - CpuFpReferenceValidation.HalfNotComparable (Skipped)
81 - CpuFpReferenceValidation.FloatNotComparable (Skipped)
82 - CpuFpReferenceValidation.DoubleNotComparable (Skipped)
83 - CpuFpReferenceValidation.ToleranceComparison (Skipped)
...
486 - RunFwdbatchnormGraphWithParams/Batchnorm_execute_graph_test.RunFloatFwdbatchnormGraph/(n:64 c:3 h:14 w:14) (Skipped)
...
489 - RunFloatFwdBatchnormGraph/Batchnorm_forward_inference_integration_test.RunFloatFwdBatchnormGraph/(n:64 c:3 h:14 w:14) (Skipped)
490 - RunFloatFwdBatchnormGraph/Batchnorm_forward_inference_integration_test.RunFloatFwdBatchnormGraph/(n:64 c:256 h:14 w:14) (Skipped)
491 - RunFloatFwdBatchnormGraph/Batchnorm_forward_inference_integration_test.RunFloatFwdBatchnormGraph/(n:64 c:256 h:28 w:28) (Skipped)
492 - RunFloatFwdBatchnormGraph/Batchnorm_forward_inference_integration_test.RunFloatFwdBatchnormGraph/(n:64 c:256 h:56 w:56) (Skipped)
493 - RunFloatFwdBatchnormGraph/Batchnorm_forward_inference_integration_test.RunFloatFwdBatchnormGraph/(n:64 c:512 h:14 w:14) (Skipped)
494 - RunFloatFwdBatchnormGraph/Batchnorm_forward_inference_integration_test.RunFloatFwdBatchnormGraph/(n:64 c:512 h:28 w:28) (Skipped)
495 - RunFloatFwdBatchnormGraph/Batchnorm_forward_inference_integration_test.RunFloatFwdBatchnormGraph/(n:64 c:512 h:7 w:7) (Skipped)
496 - RunFloatFwdBatchnormGraph/Batchnorm_forward_inference_integration_test.RunFloatFwdBatchnormGraph/(n:64 c:64 h:112 w:112) (Skipped)
497 - RunFloatFwdBatchnormGraph/Batchnorm_forward_inference_integration_test.RunFloatFwdBatchnormGraph/(n:64 c:64 h:56 w:56) (Skipped)
498 - RunBfloat16FwdBatchnormGraph/Batchnorm_forward_inference_integration_test_bfloat16.RunBfloat16FwdBatchnormGraph/(n:1 c:3 h:14 w:14) (Skipped)
499 - RunBfloat16FwdBatchnormGraph/Batchnorm_forward_inference_integration_test_bfloat16.RunBfloat16FwdBatchnormGraph/(n:2 c:3 h:14 w:14) (Skipped)
500 - RunBfloat16FwdBatchnormGraph/Batchnorm_forward_inference_integration_test_bfloat16.RunBfloat16FwdBatchnormGraph/(n:64 c:3 h:14 w:14) (Skipped)
501 - RunBfloat16FwdBatchnormGraph/Batchnorm_forward_inference_integration_test_bfloat16.RunBfloat16FwdBatchnormGraph/(n:64 c:256 h:14 w:14) (Skipped)
502 - RunBfloat16FwdBatchnormGraph/Batchnorm_forward_inference_integration_test_bfloat16.RunBfloat16FwdBatchnormGraph/(n:64 c:256 h:28 w:28) (Skipped)
503 - RunBfloat16FwdBatchnormGraph/Batchnorm_forward_inference_integration_test_bfloat16.RunBfloat16FwdBatchnormGraph/(n:64 c:256 h:56 w:56) (Skipped)
504 - RunBfloat16FwdBatchnormGraph/Batchnorm_forward_inference_integration_test_bfloat16.RunBfloat16FwdBatchnormGraph/(n:64 c:512 h:14 w:14) (Skipped)
505 - RunBfloat16FwdBatchnormGraph/Batchnorm_forward_inference_integration_test_bfloat16.RunBfloat16FwdBatchnormGraph/(n:64 c:512 h:28 w:28) (Skipped)
506 - RunBfloat16FwdBatchnormGraph/Batchnorm_forward_inference_integration_test_bfloat16.RunBfloat16FwdBatchnormGraph/(n:64 c:512 h:7 w:7) (Skipped)
507 - RunBfloat16FwdBatchnormGraph/Batchnorm_forward_inference_integration_test_bfloat16.RunBfloat16FwdBatchnormGraph/(n:64 c:64 h:112 w:112) (Skipped)
508 - RunBfloat16FwdBatchnormGraph/Batchnorm_forward_inference_integration_test_bfloat16.RunBfloat16FwdBatchnormGraph/(n:64 c:64 h:56 w:56) (Skipped)
509 - RunHalfFwdbatchnormGraph/Batchnorm_forward_inference_integration_test_half.RunHalfFwdbatchnormGraph/(n:1 c:3 h:14 w:14) (Skipped)
510 - RunHalfFwdbatchnormGraph/Batchnorm_forward_inference_integration_test_half.RunHalfFwdbatchnormGraph/(n:2 c:3 h:14 w:14) (Skipped)
511 - RunHalfFwdbatchnormGraph/Batchnorm_forward_inference_integration_test_half.RunHalfFwdbatchnormGraph/(n:64 c:3 h:14 w:14) (Skipped)
512 - RunHalfFwdbatchnormGraph/Batchnorm_forward_inference_integration_test_half.RunHalfFwdbatchnormGraph/(n:64 c:256 h:14 w:14) (Skipped)
513 - RunHalfFwdbatchnormGraph/Batchnorm_forward_inference_integration_test_half.RunHalfFwdbatchnormGraph/(n:64 c:256 h:28 w:28) (Skipped)
514 - RunHalfFwdbatchnormGraph/Batchnorm_forward_inference_integration_test_half.RunHalfFwdbatchnormGraph/(n:64 c:256 h:56 w:56) (Skipped)
515 - RunHalfFwdbatchnormGraph/Batchnorm_forward_inference_integration_test_half.RunHalfFwdbatchnormGraph/(n:64 c:512 h:14 w:14) (Skipped)
516 - RunHalfFwdbatchnormGraph/Batchnorm_forward_inference_integration_test_half.RunHalfFwdbatchnormGraph/(n:64 c:512 h:28 w:28) (Skipped)
517 - RunHalfFwdbatchnormGraph/Batchnorm_forward_inference_integration_test_half.RunHalfFwdbatchnormGraph/(n:64 c:512 h:7 w:7) (Skipped)
518 - RunHalfFwdbatchnormGraph/Batchnorm_forward_inference_integration_test_half.RunHalfFwdbatchnormGraph/(n:64 c:64 h:112 w:112) (Skipped)
519 - RunHalfFwdbatchnormGraph/Batchnorm_forward_inference_integration_test_half.RunHalfFwdbatchnormGraph/(n:64 c:64 h:56 w:56) (Skipped)
```
