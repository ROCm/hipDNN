...
#define HIPDNN_OPEN_LOG_P(...) OPEN_LOG(open::LoggingLevel::PROMOTED, __VA_ARGS__) 
#define HIPDNN_OPEN_LOG_I(...) OPEN_LOG(open::LoggingLevel::INTERNAL_ALLOC, __VA_ARGS__)
#define HIPDNN_OPEN_LOG_C(...) OPEN_LOG(open::LoggingLevel::CALLS, __VA_ARGS__)
#define HIPDNN_OPEN_LOG_M(...) OPEN_LOG(open::LoggingLevel::MARSHALLING, __VA_ARGS__)   
