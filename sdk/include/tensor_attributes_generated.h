...
#ifndef FLATBUFFERS_GENERATED_TENSORATTRIBUTES_HIPDNN_SDK_H_
#define FLATBUFFERS_GENERATED_TENSORATTRIBUTES_HIPDNN_SDK_H_
...
struct TensorAttributesT : public ::flatbuffers::NativeTable {
  ...
  int64_t uid = 0;
  std::string name{};
  hipdnn::sdk::DataType data_type = hipdnn::sdk::DataType_UNSET;
...
struct TensorAttributes FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  hipdnn::sdk::DataType data_type() const {
    return static_cast<hipdnn::sdk::DataType>(GetField<int8_t>(VT_DATA_TYPE, 0));
  }
  bool mutate_data_type(hipdnn::sdk::DataType _data_type = static_cast<hipdnn::sdk::DataType>(0)) {
...
struct TensorAttributesBuilder {
  ...
  void add_data_type(hipdnn::sdk::DataType data_type) {
...
inline ::flatbuffers::Offset<TensorAttributes> CreateTensorAttributesDirect(
  ...
  return hipdnn::sdk::CreateTensorAttributes(
      _fbb,
      uid,
      name__,
      data_type,
...
#endif  // FLATBUFFERS_GENERATED_TENSORATTRIBUTES_HIPDNN_SDK_H_
