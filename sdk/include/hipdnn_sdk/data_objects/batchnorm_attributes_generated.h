...
struct BatchnormAttributesT : public ::flatbuffers::NativeTable {
  ...
  hipdnn_sdk::data_objects::TensorID x{};
  hipdnn_sdk::data_objects::TensorID scale{};
  hipdnn_sdk::data_objects::TensorID bias{};
  hipdnn_sdk::data_objects::TensorID epsilon{};
  ...
  hipdnn_sdk::data_objects::TensorID y{};
...
inline void BatchnormAttributes::UnPackTo(BatchnormAttributesT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = x(); if (_e) _o->x = *_e; }
  { auto _e = scale(); if (_e) _o->scale = *_e; }
  { auto _e = bias(); if (_e) _o->bias = *_e; }
  { auto _e = epsilon(); if (_e) _o->epsilon = *_e; }
