...
/**
 * @brief Retrieves all engine IDs available in the engine plugin.
 *
 * @param[out] engine_ids A pointer to an array where all available engine IDs will be stored. The array must
