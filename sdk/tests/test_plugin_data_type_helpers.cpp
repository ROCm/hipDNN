...
TEST(PluginDataTypeHelpersTest, ToStringPluginStatus)
{
    ...
    EXPECT_STREQ(to_string(HIPDNN_PLUGIN_INVALID_VALUE), "HIPDNN_PLUGIN_INVALID_VALUE");
    EXPECT_STREQ(to_string(HIPDNN_PLUGIN_INTERNAL_ERROR), "HIPDNN_PLUGIN_INTERNAL_ERROR");
