...
public:
    ...
    {
        return "test_duplicate_id_a_plugin";
    }
    ...
    {
        return hipdnn_tests::plugin_constants::engine_id<Duplicate_id_a_plugin>();
    }
...
{
    Test_plugin_base::set_instance(std::make_unique<Duplicate_id_a_plugin>());
}
