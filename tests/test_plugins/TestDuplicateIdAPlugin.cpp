...
class DuplicateIdAPlugin : public TestPluginBase
{
public:
    const char* getPluginName() const override
    {
        return "test_DuplicateIdAPlugin";
    }
    ...
    {
        return hipdnn_tests::plugin_constants::engineId<DuplicateIdAPlugin>();
    }
...
{
    TestPluginBase::setInstance(std::make_unique<DuplicateIdAPlugin>());
}
