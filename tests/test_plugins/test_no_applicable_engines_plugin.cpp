...
static const char* plugin_name = "test_no_applicable_engines_plugin";
                                             ...
                                             uint32_t* num_engines)
{
    ...
    return hipdnn_plugin::try_catch([&, api_name = __func__]() {
        ...
        // Return 0 engines - no applicable engines for this graph
        *num_engines = 0;
                                                        ...
                                                        hipdnnPluginConstData_t* engine_details)
{
    ...
    return hipdnn_plugin::try_catch([&]() {
        ...
        // Since this plugin reports no applicable engines, this function should fail
                                                            ...
                                                            hipdnnPluginConstData_t* engine_details)
{
    ...
    return hipdnn_plugin::try_catch([&]() {
        ...
        // Since we never create engine details, this should fail
    ...
    hipdnnEnginePluginHandle_t handle, hipdnnEnginePluginExecutionContext_t execution_context)
{
    ...
    return hipdnn_plugin::try_catch([&]() {
        ...
        // Since we never create execution contexts, this should fail
        throw hipdnn_plugin::Hipdnn_plugin_exception(HIPDNN_PLUGIN_STATUS_INTERNAL_ERROR,
                                     ...
                                     uint32_t num_device_buffers)
{
    ...
    return hipdnn_plugin::try_catch([&]() {
        ...
        // Since this plugin reports no applicable engines, execution should fail
        throw hipdnn_plugin::Hipdnn_plugin_exception(HIPDNN_PLUGIN_STATUS_INTERNAL_ERROR,
