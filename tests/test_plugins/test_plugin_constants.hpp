...
namespace plugin_constants
{
    ...
    {
        static const std::string test_execute_fails_plugin_path = get_plugin_path(test_execute_fails_plugin_name);
        return test_execute_fails_plugin_path;
    }
    
    inline const std::string& test_no_applicable_engines_plugin_path()
    {
        static const std::string test_no_applicable_engines_plugin_path = get_plugin_path(test_no_applicable_engines_plugin_name);
