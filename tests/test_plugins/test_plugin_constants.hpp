...
inline const char* test_duplicate_ids_plugin_name = TEST_DUPLICATE_IDS_PLUGIN_NAME;
...
inline const std::string& test_duplicate_ids_plugin_path()
{
    static const std::string test_duplicate_ids_plugin_path
        = get_plugin_path(test_duplicate_ids_plugin_name);
    return test_duplicate_ids_plugin_path;
}
