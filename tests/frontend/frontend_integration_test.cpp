...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(Integration_test_case{hipdnn_tests::plugin_constants::testGoodPluginPath(),
                                            "Default plugin with manual UIDs",
                                            "DefaultPluginBatchnormTest",
                                            FailurePoint::NONE,
                                            true},
                      Integration_test_case{hipdnn_tests::plugin_constants::testGoodPluginPath(),
                                            "Default plugin with auto UIDs",
                                            "DefaultPluginBatchnormTestAutoUID",
                                            FailurePoint::NONE,
                                            false},
                      Integration_test_case{
                          hipdnn_tests::plugin_constants::testExecuteFailsPluginPath(),
                          "Execute fails plugin",
                          "ExecuteFailsPluginBatchnormTest",
                          FailurePoint::EXECUTE,
                          true},
                      Integration_test_case{
                          hipdnn_tests::plugin_constants::testNoApplicableEnginesPluginPath(),
