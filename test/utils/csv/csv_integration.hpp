...
template <typename dataType>
std::string integration_dims_to_string2(dataType *arr1, dataType *arr2,
                                        dataType *arr3, dataType *arr4,
                                        std::string a, std::string b,
...
template <typename dataType>
std::string integration_dims_to_string3(dataType *arr1, dataType *arr2,
                                        dataType *arr3, dataType *arr4,
                                        dataType *arr5, dataType *arr6,
                                        std::string a, std::string b,
                                        std::string c, std::string d,
