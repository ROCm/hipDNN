...
TEST(convolution_pooling_fwd_bwd_intg, func_check_naive_conv_pool_fwd_bwd) {
 ...
 std::string str_ip_size = integration_dims_to_string2(ip_size_cf,ip_size_pf, ip_size_cb,ip_size_pb,"Conv_fwd","MP_fwd","Conv_bwd","MP_bwd");
 std::string str_k_size = integration_dims_to_string2(k_size_cf,k_size_pf, k_size_cb,k_size_pb,"Conv_fwd","MP_fwd", "Conv_bwd","MP_bwd");
 std::string str_op_size = integration_dims_to_string2(op_size_cf,op_size_pf, op_size_cb,op_size_pb, "Conv_fwd","MP_fwd","Conv_bwd","MP_bwd");
  ...
  compute_mpool_bwd<float>(test_case, dstDataGPU.gpu(), gradData1.gpu(), dstData.gpu(), &avg_time3);
  ...
  std::cout << "\nAverage Time is: " << avg_time << "micro seconds"<<std::endl;
    ...
    std::string testname = "convolution_pooling_fwd_bwd_intg: func_check_naive_conv_pool_fwd_bwd";
