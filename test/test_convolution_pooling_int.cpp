...
/*  std::string conv_str_ip_size  = convert_to_string((int*)ip_size_c,4);
  std::string conv_str_k_size  = convert_to_string((int*)k_size_c,4);
  std::string conv_str_op_size  = convert_to_string((int*)op_size_c,4); */


  int ip_size_p[4] = {pool.mb, pool.c, pool.ih, pool.iw};
  int k_size_p[4] = {pool.mb, pool.c, pool.kh, pool.kw};
  int op_size_p[4] =  {pool.mb, pool.c, pool.ih, pool.iw};

 /* std::string pool_str_ip_size  = convert_to_string((int*)ip_size_p,4);
  std::string pool_str_k_size  = convert_to_string((int*)k_size_p,4);
  std::string pool_str_op_size  = convert_to_string((int*)op_size_p,4); */
 ...
 std::cout<<"\n Input combined dimensions:\t"<<str_ip_size<<std::endl;
