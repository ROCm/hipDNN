...
TEST(convolution_activation_fwd_bwd_intg,
  ...
  compute_hipdnn_activation_forward<float>(test_case, dstDataGPU.gpu(),
                                 dataDst.gpu(), dataType, act_mode, &avg_time2);

  compute_hipdnn_activation_backward<float>(test_case, dstDataGPU.gpu(),
                                 data_grad.gpu(), dataDst.gpu(), dataType,
                                 act_mode, &avg_time3);
...
TEST(convolution_activation_fwd_bwd_intg,
     func_check_conv_activation_fwd_bwd_medium_size) {
  ...
  std::string strt = "./result_unittest.csv";
  std::string testname = "convolution_activation_fwd_bwd_intg: func_check_conv_activation_fwd_bwd_medium_size";
  std::string filename="convolution_activation_fwd_bwd.csv";
