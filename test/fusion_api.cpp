...
TEST(fusion_api, func_check_fusion_api_CBA_batch32) {

  float avg_time = 0;

  Desc inputDesc(32, 3, 5, 5);
  Desc filterDesc(32, 3, 3, 3);
  ...
  std::string strt = "./result_unittest.csv";
  std::string testname = "fusion_api: func_check_fusion_api_CBA_batch32";
  std::string filename="fusion_CBA.csv";
