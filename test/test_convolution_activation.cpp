...
TEST(convolution_activation_fwd_intg, func_check_conv_activation_medium_size) {
  ...
  std::string strt = "./result_unittest.csv";
  std::string testname = "convolution_activation_fwd_intg: func_check_conv_activation_medium_size";
  std::string filename="convolution_activation_fwd_intg.csv";
