...
TEST(BNorm_Fwd_inference, func_check_naive_BNorm_forward_inf_batch32) {

  Desc inputDesc(32, 1, 4, 4);
  Desc outputDesc(32, 1, 4, 4);
  float avg_time = 0;
  ...
  std::string strt = "./result_unittest.csv";
  std::string testname = "BNorm_Fwd_inference: func_check_naive_BNorm_forward_inf_batch32";
  std::string filename="BNorm_Fwd_inference.csv";
