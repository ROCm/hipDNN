#ifndef TEST_CONVOLUTION_POOLING_ACT_HPP
#define TEST_CONVOLUTION_POOLING_ACT_HPP
...
void comp_conv_fwd(convulution_Size &c, dataType *src, dataType *weights,
...
template <typename dataType>
void comp_pool_fwd(test_pooling_descriptor &c, dataType *src,
...
template <typename dataType>
void comp_pool_bwd(pool_bwd &test_case, dataType *src,
...
template <typename dataType>
void comp_conv_bwd_filter(convulution_Size &c,
...
template <typename dataType>
void compute_act_fwd(activation_params_t &test_case,
                                        dataType *src,
                                        dataType *dst, float *avg_time) {
  hipdnnHandle_t hipdnn;
  checkHIPDNN(hipdnnCreate(&hipdnn));
...
template <typename dataType>
void compute_hipdnn_act_bwd(activation_params_t &test_case,
...
#endif //TEST_CONVOLUTION_POOLING_ACT_HPP
