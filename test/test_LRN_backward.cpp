...
TEST(LRN_bwd, func_check_naive_LRN_backward_batch32) {

  Desc inputDesc(32, 3, 6, 6);
  float avg_time = 0;

  Desc gradDesc(32, 3, 6, 6);
  Desc outputDesc(32, 3, 6, 6);
  ...
  std::string strt = "./result_unittest.csv";
  std::string testname = "LRN_bwd: func_check_naive_LRN_backward_batch32";
  std::string filename="LRN_bwd.csv";
...
TEST(LRN_bwd, func_check_naive_LRN_backward_batch64) {

  Desc inputDesc(64, 3, 6, 6);
  float avg_time = 0;

  Desc gradDesc(64, 3, 6, 6);
  ...
  std::string strt = "./result_unittest.csv";
  std::string testname = "LRN_bwd: func_check_naive_LRN_backward_batch64";
  std::string filename="LRN_bwd.csv";
