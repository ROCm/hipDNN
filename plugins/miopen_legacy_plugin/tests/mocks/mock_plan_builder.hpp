...
{
public:
    MOCK_METHOD(bool, is_applicable, (const hipdnn_plugin::IGraph& op_graph), (const, override));
    MOCK_METHOD(size_t,
                get_workspace_size,
                (const hipdnnEnginePluginHandle& handle, const hipdnn_plugin::IGraph& op_graph),
                (const, override));
