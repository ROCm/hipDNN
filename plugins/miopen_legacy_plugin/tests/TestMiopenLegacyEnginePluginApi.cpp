...
TEST(MiopenLegacyEnginePluginApiTest, EnginePluginGetApplicableEngineIdsValid)
{
    ...
    auto builder = hipdnn_backend::flatbuffer_utilities::createValidBatchnormGraph();
    auto serializedGraph = builder.Release();
    hipdnnPluginConstData_t opGraph
        = hipdnn_backend::flatbuffer_utilities::createValidConstDataGraph(serializedGraph);
    std::array<int64_t, 1> engineIds = {0};
    uint32_t numEngines = 0;
...
TEST(MiopenLegacyEnginePluginApiTest, EnginePluginGetWorkspaceSizeValid)
{
    ...
    hipdnnPluginConstData_t engineConfig
        = hipdnn_backend::flatbuffer_utilities::createValidConstDataEngineConfig(
